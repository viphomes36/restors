...
@section('content')
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-xl-3 col-lg-6 col-sm-6" data-aos="fade-up" data-aos-delay="150">
                    <div class="small-category-2">
                        <div class="small-category-2-thumb img-1">
                            <a href="/v2/properties-full-grid-1.html"><img src="/v2/images/popular-places/12.jpg" alt=""></a>
                        </div>
                        <div class="sc-2-detail">
                            <h4 class="sc-jb-title"><a href="/v2/properties-full-grid-1.html">New York</a></h4>
                ...
                <div class="col-xl-3 col-lg-6 col-sm-6" data-aos="fade-up" data-aos-delay="250">
                    <div class="small-category-2">
                        <div class="small-category-2-thumb img-2">
                            <a href="/v2/properties-full-grid-1.html"><img src="/v2/images/popular-places/13.jpg" alt=""></a>
                        </div>
                        <div class="sc-2-detail">
                            <h4 class="sc-jb-title"><a href="/v2/properties-full-grid-1.html">Los Angeles</a></h4>
                ...
                <div class="col-xl-3 col-lg-6 col-sm-6" data-aos="fade-up" data-aos-delay="350">
                    <div class="small-category-2">
                        <div class="small-category-2-thumb img-3">
                            <a href="/v2/properties-full-grid-1.html"><img src="/v2/images/popular-places/14.jpg" alt=""></a>
                        </div>
                        <div class="sc-2-detail">
                            <h4 class="sc-jb-title"><a href="/v2/properties-full-grid-1.html">San Francisco</a></h4>
                ...
                <div class="col-xl-3 col-lg-6 col-sm-6" data-aos="fade-up" data-aos-delay="450">
                    <div class="small-category-2">
                        <div class="small-category-2-thumb img-3">
                            <a href="/v2/properties-full-grid-1.html"><img src="/v2/images/popular-places/9.jpg" alt=""></a>
                        </div>
                        <div class="sc-2-detail">
                            <h4 class="sc-jb-title"><a href="/v2/properties-full-grid-1.html">Atlanta</a></h4>
                            <span>409 Properties</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xl-3 col-lg-6 col-sm-6" data-aos="fade-up" data-aos-delay="150">
                    <div class="small-category-2 mob-mt">
                        <div class="small-category-2-thumb img-8">
                            <a href="/v2/properties-full-grid-1.html"><img src="/v2/images/popular-places/15.jpg" alt=""></a>
                        </div>
                        <div class="sc-2-detail">
                            <h4 class="sc-jb-title"><a href="/v2/properties-full-grid-1.html">Miami</a></h4>
                ...
                <div class="col-xl-3 col-lg-6 col-sm-6" data-aos="fade-up" data-aos-delay="250">
                    <div class="small-category-2">
                        <div class="small-category-2-thumb img-10">
                            <a href="/v2/properties-full-grid-1.html"><img src="/v2/images/popular-places/10.jpg" alt=""></a>
                        </div>
                        <div class="sc-2-detail">
                            <h4 class="sc-jb-title"><a href="/v2/properties-full-grid-1.html">Chicago</a></h4>
                ...
                <div class="col-xl-3 col-lg-6 col-sm-6" data-aos="fade-up" data-aos-delay="350">
                    <div class="small-category-2 si-mt">
                        <div class="small-category-2-thumb img-11">
                            <a href="/v2/properties-full-grid-1.html"><img src="/v2/images/popular-places/5.jpg" alt=""></a>
                        </div>
                        <div class="sc-2-detail">
                            <h4 class="sc-jb-title"><a href="/v2/properties-full-grid-1.html">Houston</a></h4>
                ...
                <div class="col-xl-3 col-lg-6 col-sm-6" data-aos="fade-up" data-aos-delay="450">
                    <div class="small-category-2 no-mb si-mt">
                        <div class="small-category-2-thumb img-11">
                            <a href="/v2/properties-full-grid-1.html"><img src="/v2/images/popular-places/6.jpg" alt=""></a>
                        </div>
                        <div class="sc-2-detail">
                            <h4 class="sc-jb-title"><a href="/v2/properties-full-grid-1.html">Orlando</a></h4>
                            <span>254 Properties</span>
                        </div>
                    </div>
                </div>
    ...
    <section class="featured portfolio bg-white-2 rec-pro full-l">
        <div class="container-fluid">
                    ...
                    <div class="project-single" data-aos="fade-right">
                        ...
                        <div class="homes-content">
                            ...
                            <div class="price-properties footer pt-3 pb-0">
                                <h3 class="title mt-3">
                                    <a href="/v2/single-property-1.html">$ 150,000</a>
                                </h3>
                                <div class="compare">
            ...
            <div class="bg-all">
                <a href="/v2/properties-full-grid-1.html" class="btn btn-outline-light">View More</a>
            </div>
        </div>
    </section>
        ...
        <div class="container-fluid">
            ...
            <div class="row service-1">
                <article class="col-lg-3 col-md-6 col-xs-12 serv" data-aos="fade-up" data-aos-delay="150">
                    <div class="serv-flex">
                        <div class="art-1 img-13">
                            <img src="/v2/images/icons/icon-4.svg" alt="">
                ...
                <article class="col-lg-3 col-md-6 col-xs-12 serv" data-aos="fade-up" data-aos-delay="250">
                    <div class="serv-flex">
                        <div class="art-1 img-14">
                            <img src="/v2/images/icons/icon-5.svg" alt="">
                ...
                <article class="col-lg-3 col-md-6 col-xs-12 serv mb-0 pt" data-aos="fade-up" data-aos-delay="350">
                    <div class="serv-flex arrow">
                        <div class="art-1 img-15">
                            <img src="/v2/images/icons/icon-6.svg" alt="">
                ...
                <article class="col-lg-3 col-md-6 col-xs-12 serv mb-0 pt its-2" data-aos="fade-up" data-aos-delay="450">
                    <div class="serv-flex">
                        <div class="art-1 img-14">
                            <img src="/v2/images/icons/icon-15.svg" alt="">
                                ...
                                <div class="project-inner project-head">
                                    <div class="homes">
                                        ...
                                        <a href="/v2/single-property-1.html" class="homes-img">
                                            <div class="homes-tag button alt featured">Featured</div>
                                            <div class="homes-tag button alt sale">For Sale</div>
                                            <img src="/v2/images/blog/b-11.jpg" alt="home-1" class="img-responsive">
                                        </a>
                                    </div>
                                    <div class="button-effect">
                                        <a href="/v2/single-property-1.html" class="btn"><i class="fa fa-link"></i></a>
                                ...
                                <div class="project-inner project-head">
                                    <div class="homes">
                                        ...
                                        <a href="/v2/single-property-1.html" class="homes-img">
                                            ...
                                            <img src="/v2/images/blog/b-12.jpg" alt="home-1" class="img-responsive">
                                        </a>
                                    </div>
                                    <div class="button-effect">
                                        <a href="/v2/single-property-1.html" class="btn"><i class="fa fa-link"></i></a>
                            ...
                            <div class="project-single">
                                <div class="project-inner project-head">
                                    <div class="homes">
                                        ...
                                        <a href="/v2/single-property-1.html" class="homes-img">
                                            <div class="homes-tag button alt sale">For Sale</div>
                                            <img src="/v2/images/blog/b-1.jpg" alt="home-1" class="img-responsive">
                                        </a>
                                    </div>
                                    <div class="button-effect">
                                        <a href="/v2/single-property-1.html" class="btn"><i class="fa fa-link"></i></a>
                        ...
                        <div class="landscapes">
                            <div class="project-single no-mb">
                                <div class="project-inner project-head">
                                    <div class="homes">
                                        ...
                                        <a href="/v2/single-property-1.html" class="homes-img">
                                            <div class="homes-tag button alt featured">Featured</div>
                                            <div class="homes-tag button sale rent">For Rent</div>
                                            <img src="/v2/images/feature-properties/fp-10.jpg" alt="home-1" class="img-responsive">
                                        </a>
                                    </div>
                                    <div class="button-effect">
                                        <a href="/v2/single-property-1.html" class="btn"><i class="fa fa-link"></i></a>
                                ...
                                <div class="homes-content">
                                    ...
                                    <h3><a href="/v2/single-property-1.html">Real House Luxury Villa</a></h3>
                                    <p class="homes-address mb-3">
                                        <a href="/v2/properties-details.html">
                                            <i class="fa fa-map-marker"></i><span>Est St, 77 - Central Park South, NYC</span>
                                        </a>
                                    </p>
                                    <!-- homes List -->
                            ...
                            <div class="project-single no-mb">
                                <div class="project-inner project-head">
                                    <div class="homes">
                                        ...
                                        <a href="/v2/single-property-1.html" class="homes-img">
                                            <div class="homes-tag button alt sale">For Sale</div>
                                            <img src="/v2/images/feature-properties/fp-11.jpg" alt="home-1" class="img-responsive">
                                        </a>
                                    </div>
                                    <div class="button-effect">
                                        <a href="/v2/single-property-1.html" class="btn"><i class="fa fa-link"></i></a>
                            ...
                            <div class="project-single no-mb last">
                                <div class="project-inner project-head">
                                    <div class="homes">
                                        ...
                                        <a href="/v2/single-property-1.html" class="homes-img">
                                            <div class="homes-tag button sale rent">For Rent</div>
                                            <img src="/v2/images/feature-properties/fp-12.jpg" alt="home-1" class="img-responsive">
                                        </a>
                                    </div>
                                    <div class="button-effect">
                                        <a href="/v2/single-property-1.html" class="btn"><i class="fa fa-link"></i></a>
        ...
        <div class="container-fluid">
            ...
            <div class="row team-all">
                ...
                <div class="team-block col-sm-6 col-md-4 col-lg-4 col-xl-2" data-aos="fade-up" data-aos-delay="150">
                    <div class="inner-box team-details">
                        <div class="image team-head">
                            <a href="/v2/agents-listing-grid.html"><img src="/v2/images/team/t-5.jpg" alt="" /></a>
                            <div class="team-hover">
                                <ul class="team-social">
                                    <li><a href="/v2/#" class="facebook"><i class="fa fa-facebook"></i></a></li>
                                    <li><a href="/v2/#" class="twitter"><i class="fa fa-twitter"></i></a></li>
                                    <li><a href="/v2/#" class="instagram"><i class="fa fa-instagram"></i></a></li>
                                    <li><a href="/v2/#" class="linkedin"><i class="fa fa-linkedin"></i></a></li>
                                </ul>
                            </div>
                        </div>
                        <div class="lower-box">
                            <h3><a href="/v2/agents-listing-grid.html">Carls Jhons</a></h3>
                ...
                <div class="team-block col-sm-6 col-md-4 col-lg-4 col-xl-2" data-aos="fade-up" data-aos-delay="250">
                    <div class="inner-box team-details">
                        <div class="image team-head">
                            <a href="/v2/agents-listing-grid.html"><img src="/v2/images/team/t-6.jpg" alt="" /></a>
                            <div class="team-hover">
                                <ul class="team-social">
                                    <li><a href="/v2/#" class="facebook"><i class="fa fa-facebook"></i></a></li>
                                    <li><a href="/v2/#" class="twitter"><i class="fa fa-twitter"></i></a></li>
                        ...
                        <div class="lower-box">
                            <h3><a href="/v2/agents-listing-grid.html">Arling Tracy</a></h3>
                            <div class="designation">Real Estate Agent</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="team-block col-sm-6 col-md-4 col-lg-4 col-xl-2" data-aos="fade-up" data-aos-delay="350">
                    <div class="inner-box team-details">
                        <div class="image team-head">
                            <a href="/v2/agents-listing-grid.html"><img src="/v2/images/team/t-7.jpg" alt="" /></a>
                            <div class="team-hover">
                                <ul class="team-social">
                                    <li><a href="/v2/#" class="facebook"><i class="fa fa-facebook"></i></a></li>
                                    <li><a href="/v2/#" class="twitter"><i class="fa fa-twitter"></i></a></li>
                        ...
                        <div class="lower-box">
                            <h3><a href="/v2/agents-listing-grid.html">Mark Web</a></h3>
                            <div class="designation">Real Estate Agent</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="team-block col-sm-6 col-md-4 col-lg-4 col-xl-2 pb-none" data-aos="fade-up" data-aos-delay="450">
                    <div class="inner-box team-details">
                        <div class="image team-head">
                            <a href="/v2/agents-listing-grid.html"><img src="/v2/images/team/t-8.jpg" alt="" /></a>
                            <div class="team-hover">
                                <ul class="team-social">
                                    <li><a href="/v2/#" class="facebook"><i class="fa fa-facebook"></i></a></li>
                                    <li><a href="/v2/#" class="twitter"><i class="fa fa-twitter"></i></a></li>
                        ...
                        <div class="lower-box">
                            <h3><a href="/v2/agents-listing-grid.html">Katy Grace</a></h3>
                            <div class="designation">Real Estate Agent</div>
                        </div>
                    </div>
                </div>
                <div class="team-block col-sm-6 col-md-4 col-lg-4 col-xl-2 pb-none" data-aos="fade-up" data-aos-delay="550">
                    <div class="inner-box team-details">
                        <div class="image team-head">
                            <a href="/v2/agents-listing-grid.html"><img src="/v2/images/team/team-image-2.jpg" alt="" /></a>
                            <div class="team-hover">
                                <ul class="team-social">
                                    <li><a href="/v2/#" class="facebook"><i class="fa fa-facebook"></i></a></li>
                                    <li><a href="/v2/#" class="twitter"><i class="fa fa-twitter"></i></a></li>
                        ...
                        <div class="lower-box">
                            <h3><a href="/v2/agents-listing-grid.html">Chris Melo</a></h3>
                            <div class="designation">Real Estate Agent</div>
                        </div>
                    </div>
                </div>
                <div class="team-block col-sm-6 col-md-4 col-lg-4 col-xl-2 pb-none" data-aos="fade-up" data-aos-delay="650">
                    <div class="inner-box team-details">
                        <div class="image team-head">
                            <a href="/v2/agents-listing-grid.html"><img src="/v2/images/team/team-image-7.jpg" alt="" /></a>
                            <div class="team-hover">
                                <ul class="team-social">
                                    <li><a href="/v2/#" class="facebook"><i class="fa fa-facebook"></i></a></li>
                                    <li><a href="/v2/#" class="twitter"><i class="fa fa-twitter"></i></a></li>
                        ...
                        <div class="lower-box">
                            <h3><a href="/v2/agents-listing-grid.html">Nina Thomas</a></h3>
                            <div class="designation">Real Estate Agent</div>
                        </div>
                    </div>
                </div>
